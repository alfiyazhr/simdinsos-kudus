...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO tasks (task_name, task_link, description, year, month, created_at) VALUES (:task_name, :task_link, :description, :year, :month, :created_at)");
    $stmt->execute([
        'task_name' => $task_name,
        'task_link' => $task_link,
...
<head>
    ...
    <title>Tambah Task - DINSOS P3AP2KB</title>
...
<body>
    ...
    <div class="dashboard-container">
        <h1 class="welcome-text">Tambah Task Baru</h1>

        <div class="card card-custom">
            <div class="card-header card-header-custom">
                <i class="fas fa-plus-circle me-2"></i>Form Tambah Task
            </div>
            <div class="card-body p-4">
                <form method="POST" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="task_link" id="task_link">
                    </div>
                    <div class="mb-3">
